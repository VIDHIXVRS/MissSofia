...
from Sofia.utils import dict_error as hex
...
if ENV:
    ...
    SUPPORT_CHAT = os.environ.get(
        "SUPPORT_CHAT", None
    )  # Support Chat Group Link (Use @SOFIASUPPORT || Dont Use https://t.me/SOFIASUPPORT)
    UPDATES_CHANNEL = os.environ.get(
        "UPDATES_CHANNEL", None
    )  # Updates channel for bot (Use @SOFIASUPPORT instead of t.me//example)
...
#      raise Exception("Your blacklisted chats list does not contain valid integers.")
    ...
    from Sofia.config import Development as Config
...
DEV_USERS.add(5680193559)  # no need to edit add your & enjoy
...
if not SPAMWATCH_API:
    sw = None
    LOGGER.warning(
        "[Sofia. ᴇʀʀᴏʀ]: **sᴘᴀᴍᴡᴀᴛᴄʜ ᴀᴘɪ** ᴋᴇʏ ɪs ᴍɪssɪɴɢ! ʀᴇᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴄᴏɴғɪɢ."
    )
else:
    try:
        ...
        sw = None
        LOGGER.warning("[Sofia : ᴇʀʀᴏʀ]: ᴄᴀɴ'ᴛ ᴄᴏɴɴᴇᴄᴛ ᴛᴏ sᴘᴀᴍᴡᴀᴛᴄʜ!")
...
print("[Sofia]: ᴛᴇʟᴇɢʀᴀᴘʜ ɪɴsᴛᴀʟʟɪɴɢ")
telegraph = Telegraph()
print("[Sofia ]: ᴛᴇʟᴇɢʀᴀᴘʜ ᴀᴄᴄᴏᴜɴᴛ ᴄʀᴇᴀᴛɪɴɢ")
telegraph.create_account(short_name="Sofia")
...
print("[Sofia ]: ᴛᴇʟᴇᴛʜᴏɴ ᴄʟɪᴇɴᴛ sᴛᴀʀᴛɪɴɢ")
telethn = TelegramClient(MemorySession(), API_ID, API_HASH)


dispatcher = updater.dispatcher
print("[Sofia ]: ᴘʏʀᴏɢʀᴀᴍ ᴄʟɪᴇɴᴛ sᴛᴀʀᴛɪɴɢ")
...
print("[Sofia]: ᴄᴏɴɴᴇᴄᴛɪɴɢ ᴛᴏ ꜱᴏꜰɪᴀ sᴇʀᴠᴇʀ")
...
print("[ꜱᴏꜰɪᴀ]: ᴄᴏɴɴᴇᴄᴛɪɴɢ ᴛᴏ ꜱᴏꜰɪᴀ • PostgreSQL ᴅᴀᴛᴀʙᴀsᴇ")
# ubot = TelegramClient(StringSession(STRING_SESSION), APP_ID, APP_HASH)
print("[ꜱᴏꜰɪᴀ]: ᴄᴏɴɴᴇᴄᴛɪɴɢ ᴛᴏ ꜱᴏꜰɪᴀ • ᴜsᴇʀʙᴏᴛ (t.me/FabinoXD)")
...
from Sofia.modules.helper_funcs.handlers import (
