...
import Sofia.modules.sql.users_sql as sql
from Sofia import (
    BOT_USERNAME,
    CERT_PATH,
    DONATION_LINK,
...
from Sofia.modules import ALL_MODULES
from Sofia.modules.disable import DisableAbleCommandHandler
from Sofia.modules.helper_funcs.alternate import typing_action
from Sofia.modules.helper_funcs.chat_status import is_user_admin
from Sofia.modules.helper_funcs.misc import paginate_modules
...
*ʜᴇʟʟᴏ {} !*
━━━━━━━ *ꜱᴏꜰɪᴀ* ━━━━━━━
ꜱᴏꜰɪᴀ ʀᴏʙᴏᴛ ɪꜱ ᴀ ɢʀᴏᴜᴘ
ᴍᴀɴᴀɢᴇᴍᴇɴᴛ + ᴍᴜꜱɪᴄ ʙᴏᴛ 
ᴡʜɪᴄʜ ᴄᴀɴ ʜᴇʟᴘ ʏᴏᴜ ᴛᴏ 
ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ꜱᴇᴄᴜʀᴇ ʏᴏᴜʀ 
ɢʀᴏᴜᴘ ᴡɪᴛʜ ʜᴜɢᴇ ɢʀᴏᴜᴘ 
ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ᴘʟᴜɢɪɴꜱ ʟɪᴋᴇ; 
*ꜰɪʟᴛᴇʀꜱ*,*ɴᴏᴛᴇꜱ*,*ᴡᴇʟᴄᴏᴍᴇ*, 
*ɢᴏᴏᴅ ʙʏᴇ*,*ʙᴀɴɴɪɴɢ*,*ᴍᴜᴛɪɴɢ*, 
*ʟᴏᴄᴋs* ᴀɴᴅ ᴍᴀɴʏ ᴍᴏʀᴇ.
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="ᴍᴜꜱɪᴄ", callback_data="settings_back_helper"),
    ],
    [
        InlineKeyboardButton(
            text="ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ", url=f"https://github.com/VIDHIXVRS/MissSofia"
        )
    ],
]
...
HELP_STRINGS = """
━━━━━━━ꜱᴏꜰɪᴀ━━━━━━━
๏ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴜꜱᴀɢᴇ ᴏꜰ ꜱᴘᴇᴄɪꜰɪᴄꜱ ᴄᴏᴍᴍᴀɴᴅ
━━━━━━━ꜱᴏꜰɪᴀ━━━━━━━
"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module(f"Sofia.modules.{module_name}")
...
def Sofia_callback_data(update, context):
    query = update.callback_query
    uptime = get_readable_time((time.time() - StartTime))
    if query.data == "Sofia_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="⬅️", callback_data="Sofia_prev"),
                        InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="Sofia_back"),
                        InlineKeyboardButton(text="➡️", callback_data="Sofia_next"),
                    ]
                ]
            ),
        )
    elif query.data == "Sofia_back":
        first_name = update.effective_user.first_name
        uptime = get_readable_time((time.time() - StartTime))
        query.message.edit_text(
            PM_START_TEXT.format(
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5680193559 and DONATION_LINK:
            update.effective_message.reply_text(
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendAnimation(
                f"@{SUPPORT_CHAT}",
                animation="https://telegra.ph/file/5a8f25767a3414f65ce85.jpg",
                caption=f"""
ㅤ🥀 {dispatcher.bot.first_name} ɪs ᴀʟɪᴠᴇ ʙᴀʙʏ .....

━━━━━━━━━━━━━
⍟ **ᴍʏ ᴏᴡɴᴇʀ :** [ᴠɪᴅʜɪ](https://t.me/{OWNER_USERNAME})
...
""",
    ...
    data_callback_handler = CallbackQueryHandler(
        Sofia_callback_data, pattern=r"Sofia_", run_async=True
    )
...
if __name__ == "__main__":
    LOGGER.info(
        f"sᴜᴄᴄᴇssғᴜʟʟʏ ʟᴏᴀᴅᴇᴅ ᴍᴏᴅᴜʟᴇS Any issu JOIN @SOFIASUPPORT : {str(ALL_MODULES)}"
    )
