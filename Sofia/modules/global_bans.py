...
import Sofia.modules.sql.global_bans_sql as sql
from Sofia import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Sofia.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from Sofia.modules.helper_funcs.misc import send_to_list
from Sofia.modules.sql.users_sql import get_user_com_chats
...
def gban(update: Update, context: CallbackContext):
    ...
    if int(user_id) in WOLVES:
        message.reply_text("ᴛʜᴀᴛ's ᴀɴ Sofia! ᴛʜᴇʏ ᴄᴀɴɴᴏᴛ ʙᴇ ʙᴀɴɴᴇᴅ!")
        return
