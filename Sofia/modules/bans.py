...
from Sofia.modules.helper_funcs.extraction import extract_user_and_text
...
from Sofia.modules.log_channel import gloggable, loggable
...
@dev_plus
def fabino(update: Update, context: CallbackContext):
    args = context.args
    bot = context.bot
    try:
        chat_id = str(args[0])
...
.
• /fabino <chatid> <ᴍsɢ>*:* `ᴍᴀᴋᴇ ᴍᴇ sᴇɴᴅ ᴀ ᴍᴇssᴀɢᴇ ᴛᴏ ᴀ sᴘᴇᴄɪғɪᴄ ᴄʜᴀᴛ `.
"""
...
FabinoXD_HANDLER = CommandHandler(
    "fabino",
    fabino,
    pass_args=True,
...
dispatcher.add_handler(FabinoXD_HANDLER)
