...
from Sofia import BOT_USERNAME as HNY
from Sofia import DRAGONS as SUDO_USERS
from Sofia import pgram as pbot
from Sofia.modules.sql import forceSubscribe_sql as sql
...
❂ *ꜱᴇᴛᴜᴘ*
*ᴏɴʟʏ ᴄʀᴇᴀᴛᴏʀ*
❂ [ᴀᴅᴅ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀꜱ ᴀᴅᴍɪɴ](https://t.me/{HNY}?startgroup=new)
❂ [ᴀᴅᴅ ᴍᴇ ɪɴ your ᴄʜᴀɴɴᴇʟ ᴀꜱ ᴀᴅᴍɪɴ](https://t.me/{HNY}?startgroup=new)
