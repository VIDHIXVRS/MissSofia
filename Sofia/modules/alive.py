...
from Sofia.HNY.helper import PHOTO
from Sofia import BOT_NAME
from Sofia import BOT_USERNAME as fuck
from Sofia import OWNER_USERNAME, SUPPORT_CHAT, UPDATES_CHANNEL, pgram
...
⍟ **ʙᴏᴛ ᴠᴇʀꜱɪᴏɴ :** `1.0`
     ▱▱▱▱▱▱▱▱▱▱▱▱""",
        reply_markup=InlineKeyboardMarkup(HNY),
    )
