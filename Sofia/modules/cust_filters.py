...
from Sofia import LOGGER as log
from Sofia import dispatcher
from Sofia.modules.connection import connected
from Sofia.modules.helper_funcs.alternate import send_message, typing_action
from Sofia.modules.helper_funcs.decorators import Sofiacallback, Sofiacmd, Sofiamsg
from Sofia.modules.helper_funcs.extraction import extract_text
from Sofia.modules.helper_funcs.filters import CustomFilters
from Sofia.modules.helper_funcs.misc import build_keyboard_parser
from Sofia.modules.helper_funcs.msg_types import get_filter_type
from Sofia.modules.helper_funcs.string_handling import (
    button_markdown_parser,
    escape_invalid_curly_brackets,
    markdown_to_html,
    split_quotes,
)
from Sofia.modules.sql import cust_filters_sql as sql
...
@typing_action
@Sofiacmd(command="filters", admin_ok=True)
...
@Sofiacmd(command="filter", run_async=False)
...
# NOT ASYNC BECAUSE DISPATCHER HANDLER RAISED
@Sofiacmd(command="stop", run_async=False)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@typing_action
...
@Sofiamsg((CustomFilters.has_text & ~Filters.update.edited_message))
...
@Sofiacmd(command="removeallfilters", filters=Filters.chat_type.groups)
...
@Sofiacallback(pattern=r"filters_.*")
