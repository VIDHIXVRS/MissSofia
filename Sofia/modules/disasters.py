...
from Sofia import DEMONS, DEV_USERS, DRAGONS, OWNER_ID, TIGERS, WOLVES, dispatcher
from Sofia.modules.helper_funcs.chat_status import dev_plus, sudo_plus, whitelist_plus
from Sofia.modules.helper_funcs.extraction import extract_user
from Sofia.modules.log_channel import gloggable

ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "Sofia/elevated_users.json")
...
def addwhitelist(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in WOLVES:
        message.reply_text("ᴛʜɪs ᴜsᴇʀ ɪs ᴀʟʀᴇᴀᴅʏ ᴀ ᴛʀᴜᴇ ꜱᴏꜰɪᴀ")
        return ""
    ...
    update.effective_message.reply_text(
        f"{rt}\nsᴜᴄᴄᴇssғᴜʟʟʏ ᴘʀᴏᴍᴏᴛᴇᴅ {user_member.first_name} ᴛᴏ ᴀ ʀᴀɴᴋᴇᴅ Sofia!"
    )
...
def addtiger(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in WOLVES:
        rt += "ᴛʜɪs ᴜsᴇʀ ɪs ᴀʟʀᴇᴀᴅʏ a ꜱᴏꜰɪᴀ, ᴡᴇ ᴄᴀɴ ʙᴇ ᴄʟᴀssᴍᴀᴛᴇs ᴀs ᴡᴇʟʟ.."
        data["whitelists"].remove(user_id)
        WOLVES.remove(user_id)
...
def removewhitelist(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in WOLVES:
        ...
        return log_message
    message.reply_text("ᴛʜɪs ᴜsᴇʀ ɪs ɴᴏᴛ ᴀ ꜱᴏꜰɪᴀ!")
    return ""
...
def whitelistlist(update: Update, context: CallbackContext):
    ...
    m = update.effective_message.reply_text(
        "<code>ɢᴀᴛʜᴇʀɪɴɢ ɪɴᴛᴇʟ ғʀᴏᴍ ꜱᴏꜰɪᴀ..</code>",
...
def tigerlist(update: Update, context: CallbackContext):
    ...
    m = update.effective_message.reply_text(
        "<code>ɢᴀᴛʜᴇʀɪɴɢ ɪɴᴛᴇʟ ғʀᴏᴍ ꜱᴏꜰɪᴀ ɪǫ.</code>",
        parse_mode=ParseMode.HTML,
    )
    bot = context.bot
...
def sudolist(update: Update, context: CallbackContext):
    bot = context.bot
    m = update.effective_message.reply_text(
        "<code>ɢᴀᴛʜᴇʀɪɴɢ ɪɴᴛᴇʟ ғʀᴏᴍ ꜱᴏꜰɪᴀ ʜǫ.</code>",
        parse_mode=ParseMode.HTML,
    )
...
def devlist(update: Update, context: CallbackContext):
    bot = context.bot
    m = update.effective_message.reply_text(
        "<code>ɢᴀᴛʜᴇʀɪɴɢ ɪɴᴛᴇʟ ғʀᴏᴍ ꜱᴏꜰɪᴀ HQ..</code>",
        parse_mode=ParseMode.HTML,
    )
...
WHITELIST_HANDLER = CommandHandler(
    ("Sofia", "addwhitelist"), addwhitelist, run_async=True
)
...
WHITELISTLIST_HANDLER = CommandHandler(
    ["whitelistlist", "SofiaS"], whitelistlist, run_async=True
)
