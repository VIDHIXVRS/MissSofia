...
import Sofia.modules.sql.antilinkedchannel_sql as sql
from Sofia.modules.helper_funcs.anonymous import AdminPerms, user_admin
from Sofia.modules.helper_funcs.chat_status import bot_admin, bot_can_delete
from Sofia.modules.helper_funcs.decorators import Sofiacmd, Sofiamsg


@Sofiacmd(command="cleanlinked", group=112)
@bot_can_delete
...
@Sofiamsg(Filters.is_automatic_forward, group=111)
...
@Sofiacmd(command="antichannelpin", group=114)
@bot_admin
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@Sofiamsg(Filters.is_automatic_forward | Filters.status_update.pinned_message, group=113)
def eliminate_linked_channel_msg(update: Update, _: CallbackContext):
    message = update.effective_message
    chat = update.effective_chat
